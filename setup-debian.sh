...
echo 'Installing OpenSSH server inside Debian...'
...
echo 'Enabling and starting SSH service inside Debian...'
...
# Step 6: Expose the IP address and give SSH instructions
echo "=== Step 6: Exposing the IP address for SSH access ==="
